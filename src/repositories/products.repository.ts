...
import {Products, Client} from '../models';
...
> {
  ...
  pushToMigrationQueue(
    ...
    amqp.connect(host, function(err: any, conn: any): void {
  ...
  pushToEmailQueue(
    ...
    amqp.connect(host, function(err: any, conn: any): void {
      ...
      conn.createChannel(function(err: any, ch: any) {
        ...
        const queueName =
          process.env.DIM_EMAIL_QUEUE_NAME || 'DHIS2_EMAIL_INTEGRATION_QUEUE';
